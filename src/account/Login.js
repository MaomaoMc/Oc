    ...
    return (
      <div>
        ...
        <div className="account_form fz_26">
                <div>
                    <label>手机号</label>
                    <input className="h_80" type="text" placeholder="请填写您的手机号码" name="phone" value={this.state.phone}
                    onChange={e => {
                ...
                <div>
                    <label>请输入密码</label>
                    <input className="h_80" type="password" placeholder="请填写您的密码" name="l_pass" value={this.state.l_pass}
                    onChange={e => {
                      this.changeInputVal({'name': e.target.name, 'val': e.target.value})
                    }} />
                </div>
